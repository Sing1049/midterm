    ...
    <el-row :gutter="12">
      <el-col :span="12" v-for="(list, index) in comments" :key="index">
        <el-card shadow="always">
          <p>
            <strong>{{ list.Name }} - {{ list.Position }}</strong>
          </p>
          <p>{{ list.Comment }}</p>
        </el-card>
      </el-col>
      ...
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-row>
          ...
          <el-form-item prop="yourName">
            <el-input
              placeholder="Your Name (no more than 50 words)"
              id="userName"
          ...
          <el-form-item prop="position">
            <el-input
              placeholder="Position Title (no more than 50 words)"
              id="userPosition"
          ...
          <el-form-item prop="desc">
            <el-input
              type="textarea"
              placeholder="Your Comments (no more than 50 words)"
              id="userDesc"
              v-model="form.desc"
            ></el-input>
          </el-form-item>
      ...
      rules: {
        yourName: [
          ...
          },
          {
            min: 0,
            max: 50,
            message: "You name cannot be more than 50 words",
            trigger: ["blur", "change"]
          }
        ],
        position: [
          ...
          },
          {
            min: 0,
            max: 50,
            message: "Position title cannot be more than 50 words",
            trigger: ["blur", "change"]
          }
        ],
        desc: [
          ...
          },
          {
            min: 0,
            max: 120,
            message: "Comment cannot be more than 120 words",
            trigger: ["blur", "change"]
          }
        ]
      }
      ...
      this.$refs[form].validate(valid => {
        if (valid) {
          ...
          axios
            ...
            .post(
              "https://xie00053-vue-and-axios.firebaseio.com/data.json",
              JSON.stringify(obj)
            )
            .then(response => {
